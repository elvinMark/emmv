...
# Form implementation generated from reading ui file './ui/enter_check.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 451, 101))
        ...
        self.pushButton.clicked.connect(Form.enter_new_check)
        QtCore.QMetaObject.connectSlotsByName(Form)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "Ingresos por Cheque"))
        ...
        self.label_2.setText(_translate("Form", "Nombre de la persona:"))
        self.label_3.setText(_translate("Form", "Importe:"))
        self.label.setText(_translate("Form", "Numero de Cheque:"))
        self.pushButton.setText(_translate("Form", "Ingresar"))

    def setSlots(self,Form):
        def enter_new_check():
            pass
        Form.enter_new_check = enter_new_check
