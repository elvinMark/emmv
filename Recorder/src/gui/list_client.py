...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(20, 10, 331, 181))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(20, 200, 331, 31))
        ...
        Form.selectClient = selectClient
        ##############################################
        
        self.pushButton.clicked.connect(Form.selectClient)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Lista de Clientes"))
